...
export function bufferHash(strOrBuffer: string | BrowserBuffer, algo?: string): Promise<Uint8Array>;
export function browserHash(strOrBuffer: string | BrowserBuffer, algo?: string): Promise<string>;
